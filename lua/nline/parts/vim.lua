...
function parts.mode(opts)
  ...
  return function()
    ...
    elseif m == "" then
      return with_hl(
        opts.texts.visual_block or default_opts.texts.visual_block,
        opts.hls.visual_block or default_opts.hls.visual_block
      )
    elseif m == "i" then
    ...
    elseif m == "ic" or m == "ix" then
      return with_hl(
        opts.texts.insert_complete or default_opts.texts.insert_complete,
        opts.hls.insert_complete or default_opts.hls.insert_complete
      )
    elseif m == "c" then
